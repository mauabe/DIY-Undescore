...
//////////////////////
 ...
 //  * =========
  ...
  _.memoize = function(func) {
    ...
    return function(){
      ...
      if( !obj.hasOwnProperty(input) ){
        obj[input] = func.apply(null, arguments);
      }
      return obj[input];
    }
  };
  ...
  _.zip = function() {
    var maxi = 0;
    var result = new Array(maxi);

    _.each(arguments, function(arg) {
      maxi = Math.max(arg.length, maxi);
    });
  ...
  _.difference = function(array) {
    var other = _.flatten([].slice.call(arguments, 1));
    return _.filter(array, function(elem) {
        return _.contains(other, elem) ? false : true;
    });
};